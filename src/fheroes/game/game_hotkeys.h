...
namespace Game
{
    ...
    fheroes::Key getHotKeyForEvent( const HotKeyEvent eventID );
    void setHotKeyForEvent( const HotKeyEvent eventID, const fheroes::Key key );
    ...
    void globalKeyDownEvent( const fheroes::Key key, const int32_t modifier );
