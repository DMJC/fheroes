...
namespace
{
    fheroes::Rect getKnightBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
    ...
    fheroes::Rect getBarbarianBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
            return { 466, 94, 87, 47 };
    ...
    fheroes::Rect getSorceressBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
    ...
    fheroes::Rect getWarlockBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
    ...
    fheroes::Rect getWizardBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
            return { 505, 50, 51, 49 };
    ...
    fheroes::Rect getNecromancerBuildingArea( const BuildingType buildingId )
    {
        switch ( buildingId ) {
        case BUILD_THIEVESGUILD:
...
namespace fheroes
{
    ...
    std::string getBuildingRequirementString( const int race, const BuildingType building )
    {
        ...
        const uint32_t requirementBuildingIds = fheroes::getBuildingRequirement( race, building );
        const char sep = '\n';
