...
public:
    ...
    std::list<MapBaseObject *> get( const fheroes::Point & pos ) const;
...
class World : protected fheroes::Size
{
public:
    ...
    const Castle * getCastle( const fheroes::Point & tilePosition ) const
    {
        return vec_castles.Get( tilePosition );
    }

    Castle * getCastle( const fheroes::Point & tilePosition )
    {
        return vec_castles.Get( tilePosition );
    }
    ...
    void removeCastle( const fheroes::Point & tilePosition )
    {
    ...
    const Castle * getCastleEntrance( const fheroes::Point & tilePosition ) const;
    Castle * getCastleEntrance( const fheroes::Point & tilePosition );
    ...
    const Heroes * GetHeroes( const fheroes::Point & center ) const
    {
        return vec_heroes.Get( center );
    }

    Heroes * GetHeroes( const fheroes::Point & center )
    {
        return vec_heroes.Get( center );
    }
    ...
    bool DiggingForUltimateArtifact( const fheroes::Point & center );
    ...
    fheroes::LocalizedString getCurrentRumor() const;
    ...
    MapEvent * GetMapEvent( const fheroes::Point & pos );
...
private:
    ...
    bool isValidCastleEntrance( const fheroes::Point & tilePosition ) const;
