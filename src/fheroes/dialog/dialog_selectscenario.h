...
public:
    ...
    explicit ScenarioListBox( const fheroes::Point & pt )
...
private:
    ...
    void _renderScenarioListItem( const Maps::FileInfo & info, fheroes::Display & display, const int32_t dsty, const bool current ) const;
    void _renderSelectedScenarioInfo( fheroes::Display & display, const fheroes::Point & dst );
    void _renderMapName( const Maps::FileInfo & info, bool selected, const int32_t & baseYOffset, fheroes::Display & display ) const;
    static void _renderMapIcon( const uint16_t size, fheroes::Display & display, const int32_t coordX, const int32_t coordY );
    static const fheroes::Sprite & _getPlayersCountIcon( const PlayerColorsSet colors );
    static const fheroes::Sprite & _getMapTypeIcon( const GameVersion version );
    static const fheroes::Sprite & _getWinConditionsIcon( const uint8_t condition );
    static const fheroes::Sprite & _getLossConditionsIcon( const uint8_t condition );
};
