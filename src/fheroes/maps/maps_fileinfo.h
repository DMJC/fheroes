...
namespace Maps
{
    ...
    public:
        ...
        {
            // In the original game artifact IDs start from 0 but for the victory condition it starts from 1 which aligns with fheroes artifact enumeration.
        ...
        fheroes::Point WinsMapsPositionObject() const
        {
            return { victoryConditionParams[0], victoryConditionParams[1] };
        }

        fheroes::Point LossMapsPositionObject() const
        {
        ...
        std::optional<fheroes::SupportedLanguage> getSupportedLanguage() const
        {
        ...
        fheroes::SupportedLanguage mainLanguage{ fheroes::SupportedLanguage::English };
