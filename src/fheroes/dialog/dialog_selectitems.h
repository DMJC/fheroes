...
namespace Dialog
{
    ...
    public:
        ...
        explicit ItemSelectionWindow( const fheroes::Size & dialogSize, std::string title, std::string description = {} );
        ...
        void renderItem( const fheroes::Sprite & itemSprite, std::string itemText, const fheroes::Point & destination, const int32_t middleImageOffsetX,
                         const int32_t textOffsetX, const int32_t itemOffsetY, const bool current ) const;

        void renderItem( const fheroes::Sprite & itemSprite, std::vector<fheroes::LocalizedString> itemText, const fheroes::Point & destination,
        ...
        fheroes::Rect getBackgroundArea() const;
    ...
    private:
        ...
        std::unique_ptr<fheroes::ImageRestorer> _backgroundRestorer;
        fheroes::Button _buttonOk;
        fheroes::Button _buttonCancel;
        ...
        void renderText( fheroes::TextBase & text, const fheroes::Point & destination, const int32_t textOffsetX, const int32_t itemOffsetY ) const;
    };
