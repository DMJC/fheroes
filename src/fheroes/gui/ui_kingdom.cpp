...
namespace fheroes
{
    ...
    void showLighthouseInfo( const Kingdom & kingdom, const int buttons )
    {
        ...
        const int32_t topOffset = fheroes::tileWidthPx - lighthouseTop.height();

        Image combined( 5 * fheroes::tileWidthPx, 2 * fheroes::tileWidthPx + lighthouseTop.height() );
        combined.reset();

        Copy( shadowTop, 0, 0, combined, shadowTop.x(), fheroes::tileWidthPx + shadowTop.y() - topOffset, fheroes::tileWidthPx, fheroes::tileWidthPx );
        Copy( shadowMiddle, 0, 0, combined, shadowMiddle.x(), fheroes::tileWidthPx * 2 + shadowMiddle.y() - topOffset, fheroes::tileWidthPx, fheroes::tileWidthPx );
        Copy( shadowBottom, 0, 0, combined, fheroes::tileWidthPx + shadowBottom.x(), fheroes::tileWidthPx * 2 + shadowBottom.y() - topOffset, fheroes::tileWidthPx,
              fheroes::tileWidthPx );
        Copy( lighthouseTop, 0, 0, combined, fheroes::tileWidthPx * 2 + lighthouseTop.x(), lighthouseTop.y() - topOffset, fheroes::tileWidthPx, fheroes::tileWidthPx );
        Copy( lighthouseMiddle, 0, 0, combined, fheroes::tileWidthPx * 2 + lighthouseMiddle.x(), fheroes::tileWidthPx + lighthouseMiddle.y() - topOffset,
              fheroes::tileWidthPx, fheroes::tileWidthPx );
        Copy( lighthouseBottom, 0, 0, combined, fheroes::tileWidthPx * 2 + lighthouseBottom.x(), fheroes::tileWidthPx * 2 + lighthouseBottom.y() - topOffset,
              fheroes::tileWidthPx, fheroes::tileWidthPx );
        ...
        const CustomAnimationDialogElement lighthouseCustomDynamicImageElement( ICN::OBJNMUL2, combined,
                                                                                { fheroes::tileWidthPx * 2 + lighthouseLight.x(),
                                                                                  fheroes::tileWidthPx + lighthouseLight.y() - topOffset },
