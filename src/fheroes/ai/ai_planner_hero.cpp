...
fheroes::GameMode AI::Planner::HeroesTurn( VecHeroes & heroes, uint32_t & currentProgressValue, uint32_t endProgressValue, bool & moreTasksAvailable )
{
...

        {
            ...
            if ( shouldUseDimensionDoor( regularMovementDist, dimensionDoorDist ) ) {
                ...
                if ( dimensionDoorDist > 0 ) {
                    ...
                    const fheroes::GameMode gameState = HeroesMove( *bestHero );
