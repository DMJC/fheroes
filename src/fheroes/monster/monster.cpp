...
{
    return fheroes::getMonsterData( id ).battleStats.attack;
}

uint32_t Monster::GetDefense() const
{
    return fheroes::getMonsterData( id ).battleStats.defense;
}
...
{
    return fheroes::getMonsterData( id ).generalStats.race;
}

uint32_t Monster::GetShots() const
{
    return fheroes::getMonsterData( id ).battleStats.shots;
}
...
double Monster::GetMonsterStrength( int attack /* = -1 */, int defense /* = -1 */ ) const
{
    ...
    return attackDefense * fheroes::getMonsterData( id ).battleStats.monsterBaseStrength;
}
...
bool Monster::isAbilityPresent( const fheroes::MonsterAbilityType abilityType ) const
{
    return fheroes::isAbilityPresent( fheroes::getMonsterData( id ).battleStats.abilities, abilityType );
}

bool Monster::isWeaknessPresent( const fheroes::MonsterWeaknessType weaknessType ) const
{
    return fheroes::isWeaknessPresent( fheroes::getMonsterData( id ).battleStats.weaknesses, weaknessType );
}
...
{
    return _( fheroes::getMonsterData( id ).generalStats.untranslatedName );
}

const char * Monster::GetMultiName() const
{
    return _( fheroes::getMonsterData( id ).generalStats.untranslatedPluralName );
}

const char * Monster::GetPluralName( uint32_t count ) const
{
    const fheroes::MonsterGeneralStats & generalStats = fheroes::getMonsterData( id ).generalStats;
