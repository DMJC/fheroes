...
public:
    ...
    {
        return fheroes::getMonsterData( id ).battleStats.damageMin;
    }

    uint32_t GetDamageMax() const
    {
        return fheroes::getMonsterData( id ).battleStats.damageMax;
    }
    ...
    {
        return fheroes::getMonsterData( id ).battleStats.hp;
    }

    uint32_t GetSpeed() const
    {
        return fheroes::getMonsterData( id ).battleStats.speed;
    }

    uint32_t GetGrown() const
    {
        return fheroes::getMonsterData( id ).generalStats.baseGrowth;
    }

    int GetMonsterLevel() const
    {
        return fheroes::getMonsterData( id ).generalStats.level;
    }
    ...
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::ELEMENTAL );
    }

    bool isUndead() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::UNDEAD );
    }

    bool isFlying() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::FLYING );
    }

    bool isWide() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::DOUBLE_HEX_SIZE );
    }
    ...
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::HP_REGENERATION );
    }

    bool isDoubleCellAttack() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::TWO_CELL_MELEE_ATTACK );
    }

    bool isAllAdjacentCellsAttack() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::ALL_ADJACENT_CELL_MELEE_ATTACK );
    }

    bool isIgnoringRetaliation() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::NO_ENEMY_RETALIATION );
    }

    bool isDragons() const
    {
        return isAbilityPresent( fheroes::MonsterAbilityType::DRAGON );
    }
    ...
    bool isAbilityPresent( const fheroes::MonsterAbilityType abilityType ) const;

    bool isWeaknessPresent( const fheroes::MonsterWeaknessType weaknessType ) const;
    ...
    Funds GetCost() const
    {
        return Funds( fheroes::getMonsterData( id ).generalStats.cost );
    }
    ...
    {
        return fheroes::getMonsterData( id ).icnId;
    }
