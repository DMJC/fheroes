...
{
    return _( fheroes::getArtifactData( id ).untranslatedName );
}
...
double Artifact::getArtifactValue() const
{
    ...
    const fheroes::ArtifactData & data = fheroes::getArtifactData( id );
    const std::vector<fheroes::ArtifactBonus> & bonuses = data.bonuses;
    const std::vector<fheroes::ArtifactCurse> & curses = data.curses;

    for ( const fheroes::ArtifactBonus & bonus : bonuses ) {
        switch ( bonus.type ) {
        case fheroes::ArtifactBonusType::GOLD_INCOME:
            artifactValue += static_cast<double>( bonus.value ) / 800.0;
            break;
        case fheroes::ArtifactBonusType::SEA_MOBILITY:
            artifactValue += static_cast<double>( bonus.value ) / 500.0;
            break;
        case fheroes::ArtifactBonusType::LAND_MOBILITY:
            artifactValue += static_cast<double>( bonus.value ) / 200.0;
            break;
        case fheroes::ArtifactBonusType::CURSE_SPELL_COST_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::BLESS_SPELL_COST_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::SUMMONING_SPELL_COST_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::MIND_INFLUENCE_SPELL_COST_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::COLD_SPELL_DAMAGE_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::FIRE_SPELL_DAMAGE_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::LIGHTNING_SPELL_DAMAGE_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::ELEMENTAL_SPELL_DAMAGE_REDUCTION_PERCENT:
        case fheroes::ArtifactBonusType::HYPNOTIZE_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
        case fheroes::ArtifactBonusType::COLD_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
        case fheroes::ArtifactBonusType::FIRE_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
        case fheroes::ArtifactBonusType::LIGHTNING_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
        case fheroes::ArtifactBonusType::RESURRECT_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
        case fheroes::ArtifactBonusType::SUMMONING_SPELL_EXTRA_EFFECTIVENESS_PERCENT:
            artifactValue += static_cast<double>( bonus.value ) / 50.0;
            break;
        case fheroes::ArtifactBonusType::NECROMANCY_SKILL:
        case fheroes::ArtifactBonusType::SURRENDER_COST_REDUCTION_PERCENT:
            artifactValue += static_cast<double>( bonus.value ) / 10.0;
            break;
        case fheroes::ArtifactBonusType::EVERY_COMBAT_SPELL_DURATION:
        case fheroes::ArtifactBonusType::SPELL_POINTS_DAILY_GENERATION:
            artifactValue += static_cast<double>( bonus.value ) / 2.0;
            break;
        case fheroes::ArtifactBonusType::CURSE_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::HYPNOTIZE_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::DEATH_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::BERSERK_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::BLIND_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::PARALYZE_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::HOLY_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::DISPEL_SPELL_IMMUNITY:
        case fheroes::ArtifactBonusType::ENDLESS_AMMUNITION:
        case fheroes::ArtifactBonusType::NO_SHOOTING_PENALTY:
        case fheroes::ArtifactBonusType::VIEW_MONSTER_INFORMATION:
        case fheroes::ArtifactBonusType::ADD_SPELL:
        case fheroes::ArtifactBonusType::EXTRA_CATAPULT_SHOTS:
            artifactValue += 1;
            break;
        case fheroes::ArtifactBonusType::MAXIMUM_MORALE:
        case fheroes::ArtifactBonusType::DISABLE_ALL_SPELL_COMBAT_CASTING:
        case fheroes::ArtifactBonusType::MAXIMUM_LUCK:
            artifactValue += 3;
            break;
        case fheroes::ArtifactBonusType::KNOWLEDGE_SKILL:
        case fheroes::ArtifactBonusType::ATTACK_SKILL:
        case fheroes::ArtifactBonusType::DEFENCE_SKILL:
        case fheroes::ArtifactBonusType::SPELL_POWER_SKILL:
        case fheroes::ArtifactBonusType::MORALE:
        case fheroes::ArtifactBonusType::LUCK:
        case fheroes::ArtifactBonusType::AREA_REVEAL_DISTANCE:
        ...
        case fheroes::ArtifactBonusType::SEA_BATTLE_LUCK_BOOST:
        case fheroes::ArtifactBonusType::SEA_BATTLE_MORALE_BOOST:
            artifactValue += bonus.value;
            break;
        case fheroes::ArtifactBonusType::NONE:
            break;
        default:
    ...
    for ( const fheroes::ArtifactCurse & curse : curses ) {
        switch ( curse.type ) {
        case fheroes::ArtifactCurseType::GOLD_PENALTY:
            artifactValue -= static_cast<double>( curse.value ) / 200.0;
            break;
        case fheroes::ArtifactCurseType::COLD_SPELL_EXTRA_DAMAGE_PERCENT:
        case fheroes::ArtifactCurseType::FIRE_SPELL_EXTRA_DAMAGE_PERCENT:
            artifactValue -= static_cast<double>( curse.value ) / 100.0;
            break;
        case fheroes::ArtifactCurseType::NO_JOINING_ARMIES:
        case fheroes::ArtifactCurseType::UNDEAD_MORALE_PENALTY:
            artifactValue -= 1;
            break;
        case fheroes::ArtifactCurseType::MORALE:
        case fheroes::ArtifactCurseType::SPELL_POWER_SKILL:
...
{
    const std::vector<fheroes::ArtifactBonus> & bonuses = fheroes::getArtifactData( id ).bonuses;
    for ( const fheroes::ArtifactBonus & bonus : bonuses ) {
        if ( bonus.type == fheroes::ArtifactBonusType::ADD_SPELL ) {
...
{
    return _( fheroes::getArtifactData( art.GetID() ).untranslatedDiscoveryEventDescription );
}
...
bool BagArtifacts::isArtifactBonusPresent( const fheroes::ArtifactBonusType type ) const
{
    for ( const Artifact & artifact : *this ) {
        const std::vector<fheroes::ArtifactBonus> & bonuses = fheroes::getArtifactData( artifact.GetID() ).bonuses;
        if ( std::find( bonuses.begin(), bonuses.end(), fheroes::ArtifactBonus( type ) ) != bonuses.end() ) {
            return true;
        }
    }
...
bool BagArtifacts::isArtifactCursePresent( const fheroes::ArtifactCurseType type ) const
{
    for ( const Artifact & artifact : *this ) {
        const std::vector<fheroes::ArtifactCurse> & curses = fheroes::getArtifactData( artifact.GetID() ).curses;
        if ( std::find( curses.begin(), curses.end(), fheroes::ArtifactCurse( type ) ) != curses.end() ) {
            return true;
        }
    }
...
int32_t BagArtifacts::getTotalArtifactEffectValue( const fheroes::ArtifactBonusType bonus ) const
{
    // If this assertion blows up you're calling the method for a wrong type.
    assert( !fheroes::isBonusMultiplied( bonus ) && !fheroes::isBonusUnique( bonus ) );

    int32_t totalValue = 0;

    if ( fheroes::isBonusCumulative( bonus ) ) {
        for ( const Artifact & artifact : *this ) {
            const std::vector<fheroes::ArtifactBonus> & bonuses = fheroes::getArtifactData( artifact.GetID() ).bonuses;
            auto bonusIter = std::find( bonuses.begin(), bonuses.end(), fheroes::ArtifactBonus( bonus ) );
        ...
        for ( const Artifact & artifact : *this ) {
            ...
            const std::vector<fheroes::ArtifactBonus> & bonuses = fheroes::getArtifactData( artifactId ).bonuses;
            auto bonusIter = std::find( bonuses.begin(), bonuses.end(), fheroes::ArtifactBonus( bonus ) );
            if ( bonusIter != bonuses.end() ) {
                totalValue += bonusIter->value;
            }
...
int32_t BagArtifacts::getTotalArtifactEffectValue( const fheroes::ArtifactBonusType bonus, std::string & description ) const
{
    // If this assertion blows up you're calling the method for a wrong type.
    assert( !fheroes::isBonusMultiplied( bonus ) && !fheroes::isBonusUnique( bonus ) );
...
int32_t BagArtifacts::getTotalArtifactEffectValue( const fheroes::ArtifactCurseType curse ) const
{
    // If this assertion blows up you're calling the method for a wrong type.
    assert( !fheroes::isCurseMultiplied( curse ) && !fheroes::isCurseUnique( curse ) );

    int32_t totalValue = 0;

    if ( fheroes::isCurseCumulative( curse ) ) {
        for ( const Artifact & artifact : *this ) {
            const std::vector<fheroes::ArtifactCurse> & curses = fheroes::getArtifactData( artifact.GetID() ).curses;
            auto curseIter = std::find( curses.begin(), curses.end(), fheroes::ArtifactCurse( curse ) );
        ...
        for ( const Artifact & artifact : *this ) {
            ...
            const std::vector<fheroes::ArtifactCurse> & curses = fheroes::getArtifactData( artifactId ).curses;
            auto curseIter = std::find( curses.begin(), curses.end(), fheroes::ArtifactCurse( curse ) );
            if ( curseIter != curses.end() ) {
                totalValue += curseIter->value;
            }
...
int32_t BagArtifacts::getTotalArtifactEffectValue( const fheroes::ArtifactCurseType curse, std::string & description ) const
{
    // If this assertion blows up you're calling the method for a wrong type.
    assert( !fheroes::isCurseMultiplied( curse ) && !fheroes::isCurseUnique( curse ) );
...
std::vector<int32_t> BagArtifacts::getTotalArtifactMultipliedPercent( const fheroes::ArtifactBonusType bonus ) const
{
    if ( !fheroes::isBonusMultiplied( bonus ) ) {
...
std::vector<int32_t> BagArtifacts::getTotalArtifactMultipliedPercent( const fheroes::ArtifactCurseType curse ) const
{
    if ( !fheroes::isCurseMultiplied( curse ) ) {
...
Artifact BagArtifacts::getFirstArtifactWithBonus( const fheroes::ArtifactBonusType bonus ) const
{
    for ( const Artifact & artifact : *this ) {
        const std::vector<fheroes::ArtifactBonus> & bonuses = fheroes::getArtifactData( artifact.GetID() ).bonuses;
        auto bonusIter = std::find( bonuses.begin(), bonuses.end(), fheroes::ArtifactBonus( bonus ) );
...
Artifact BagArtifacts::getFirstArtifactWithCurse( const fheroes::ArtifactCurseType curse ) const
{
    for ( const Artifact & artifact : *this ) {
        const std::vector<fheroes::ArtifactCurse> & curses = fheroes::getArtifactData( artifact.GetID() ).curses;
        auto curseIter = std::find( curses.begin(), curses.end(), fheroes::ArtifactCurse( curse ) );
...
void BagArtifacts::exchangeArtifacts( Heroes & taker, Heroes & giver )
{
    ...
    const auto isPureCursedArtifact = []( const Artifact & artifact ) {
        const fheroes::ArtifactData & data = fheroes::getArtifactData( artifact.GetID() );
    ...
    if ( !taker.HasSecondarySkill( Skill::Secondary::NECROMANCY ) && giver.HasSecondarySkill( Skill::Secondary::NECROMANCY ) ) {
        const auto isNecromancyArtifact = []( const Artifact & artifact ) {
            ...
            for ( const fheroes::ArtifactBonus & bonus : data.bonuses ) {
                if ( bonus.type != fheroes::ArtifactBonusType::NECROMANCY_SKILL ) {
                    return false;
                }
            }
    ...
    const auto isUniqueArtifact = []( const Artifact & artifact ) {
        ...
        for ( const fheroes::ArtifactBonus & bonus : data.bonuses ) {
            if ( fheroes::isBonusCumulative( bonus.type ) ) {
                return false;
            }
        }
...
void fheroes::ResetArtifactStats()
{
    std::fill( artifactGlobalStatus.begin(), artifactGlobalStatus.end(), static_cast<uint8_t>( 0 ) );
}

void fheroes::ExcludeArtifactFromRandom( const int artifactID )
{
...
bool fheroes::isPriceOfLoyaltyArtifact( const int artifactID )
{
...
{
    if ( use_mini_sprite ) {
        const fheroes::Sprite & sprite = fheroes::AGG::GetICN( ICN::HSICONS, 0 );
        const fheroes::Rect rt( 26, 21, 32, 32 );

        backsf.resize( rt.width + 2, rt.height + 2 );
        backsf.reset();

        fheroes::DrawBorder( backsf, fheroes::GetColorId( 0xD0, 0xC0, 0x48 ) );
        fheroes::Blit( sprite, rt.x, rt.y, backsf, 1, 1, rt.width, rt.height );

        setSingleItemSize( { backsf.width(), backsf.height() } );

        spcursor.resize( backsf.width(), backsf.height() );
        spcursor.reset();
        fheroes::DrawBorder( spcursor, 214 );
    }
    else {
        const fheroes::Sprite & sprite = fheroes::AGG::GetICN( ICN::ARTIFACT, 0 );
        setSingleItemSize( { sprite.width(), sprite.height() } );

        spcursor.resize( 70, 70 );
        spcursor.reset();
        fheroes::DrawRect( spcursor, { 0, 0, 70, 70 }, 190 );
        fheroes::DrawRect( spcursor, { 1, 1, 68, 68 }, 180 );
        fheroes::DrawRect( spcursor, { 2, 2, 66, 66 }, 190 );
    }
}
...
void ArtifactsBar::Redraw( fheroes::Image & dstsf )
{
    spcursor.hide();
    Interface::ItemsActionBar<Artifact>::Redraw( dstsf );
}

void ArtifactsBar::RedrawBackground( const fheroes::Rect & pos, fheroes::Image & dstsf )
{
    if ( use_mini_sprite )
        fheroes::Blit( backsf, dstsf, pos.x, pos.y );
    else
        fheroes::Blit( fheroes::AGG::GetICN( ICN::ARTIFACT, 0 ), dstsf, pos.x, pos.y );
}

void ArtifactsBar::RedrawItem( Artifact & art, const fheroes::Rect & pos, bool selected, fheroes::Image & dstsf )
{
    if ( art.isValid() ) {
        if ( use_mini_sprite ) {
            const fheroes::Sprite & artifactSprite = fheroes::AGG::GetICN( ICN::ARTFX, art.IndexSprite32() );
            fheroes::Fill( dstsf, pos.x + 1, pos.y + 1, artifactSprite.width(), artifactSprite.height(), 0 );
            fheroes::Blit( artifactSprite, dstsf, pos.x + 1, pos.y + 1 );
        }
        else {
            const fheroes::Sprite & artifactSprite = fheroes::AGG::GetICN( ICN::ARTIFACT, art.IndexSprite64() );
            fheroes::Fill( dstsf, pos.x, pos.y, artifactSprite.width(), artifactSprite.height(), 0 );
            fheroes::Blit( artifactSprite, dstsf, pos.x, pos.y );
        }
        ...
        if ( can_change ) {
            ...
            if ( isMagicBook( art ) ) {
                ...
                if ( _hero->HaveSpellBook() ) {
                    fheroes::showStandardTextMessage( Artifact( Artifact::MAGIC_BOOK ).GetName(), _( "You cannot have multiple spell books." ), Dialog::OK );
                }
                else {
...
{
    if ( art.isValid() ) {
        fheroes::ArtifactDialogElement( art ).showPopup( Dialog::OK );
    }
...
{
    fheroes::showStandardTextMessage( "", _( "This item can't be traded." ), Dialog::OK );
}
