...
namespace Battle
{
    ...
    public:
        ...
        const fheroes::Rect & GetPos() const
        {
            return _pos;
        }
        ...
        AttackDirection GetTriangleDirection( const fheroes::Point & dst ) const;

        bool isPositionIncludePoint( const fheroes::Point & pt ) const;

        void SetArea( const fheroes::Rect & area );
    ...
    private:
        ...
        int _object{ 0 };
        Unit * _unit{ nullptr };
        std::array<fheroes::Point, 7> _coord;
    };
