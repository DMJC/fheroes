...
namespace
{
    void HeroesTownGate( Heroes & hero, const Castle * castle )
    {
        ...
        const fheroes::Point fromPosition = hero.GetCenter();
        // Position of Hero on radar before casting the spell to clear it after casting.
        const fheroes::Rect fromRoi( fromPosition.x, fromPosition.y, 1, 1 );
    ...
    bool ActionSpellIdentifyHero( const Heroes & hero )
    {
        ...
        fheroes::showStandardTextMessage( _( "Identify Hero" ), _( "Enemy heroes are now fully identifiable." ), Dialog::OK );
    ...
    bool ActionSpellVisions( Heroes & hero )
    {
        ...
        for ( const int32_t monsterIndex : monsters ) {
            ...
            fheroes::showStandardTextMessage( hdr, msg, Dialog::OK );
        }
    ...
    bool ActionSpellSetGuardian( const Heroes & hero, const Spell & spell )
    {
        ...
        const uint32_t count = fheroes::getGuardianMonsterCount( spell, hero.GetPower(), &hero );
