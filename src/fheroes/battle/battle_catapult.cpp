    ...
    , canMiss( true )
{
    ...
    catShots += hero.GetBagArtifacts().getTotalArtifactEffectValue( fheroes::ArtifactBonusType::EXTRA_CATAPULT_SHOTS );
}
...
fheroes::Point Battle::Catapult::GetTargetPosition( const CastleDefenseStructure target, const bool hit )
{
    switch ( target ) {
    case CastleDefenseStructure::WALL1:
        return hit ? fheroes::Point( 475, 45 ) : fheroes::Point( 495, 105 );
    case CastleDefenseStructure::WALL2:
        return hit ? fheroes::Point( 420, 115 ) : fheroes::Point( 460, 175 );
    case CastleDefenseStructure::WALL3:
        return hit ? fheroes::Point( 415, 280 ) : fheroes::Point( 455, 280 );
    case CastleDefenseStructure::WALL4:
        return hit ? fheroes::Point( 490, 390 ) : fheroes::Point( 530, 390 );
    case CastleDefenseStructure::TOWER1:
        return hit ? fheroes::Point( 430, 40 ) : fheroes::Point( 490, 120 );
    case CastleDefenseStructure::TOWER2:
        return hit ? fheroes::Point( 430, 300 ) : fheroes::Point( 490, 340 );
    case CastleDefenseStructure::BRIDGE:
        return hit ? fheroes::Point( 400, 195 ) : fheroes::Point( 450, 235 );
    case CastleDefenseStructure::CENTRAL_TOWER:
        return hit ? fheroes::Point( 580, 160 ) : fheroes::Point( 610, 320 );
    case CastleDefenseStructure::TOP_BRIDGE_TOWER:
        return hit ? fheroes::Point( 395, 152 ) : fheroes::Point( 445, 202 );
    case CastleDefenseStructure::BOTTOM_BRIDGE_TOWER:
        return hit ? fheroes::Point( 395, 240 ) : fheroes::Point( 445, 290 );
    default:
        break;
    }
