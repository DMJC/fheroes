...
public:
    ...
    const fheroes::Point & GetPatrolCenter() const
    {
        return _patrolCenter;
    }

    void SetPatrolCenter( const fheroes::Point & pos )
    {
        _patrolCenter = pos;
    }
    ...
    bool Recruit( const PlayerColor col, const fheroes::Point & pt );
    ...
    void PortraitRedraw( const int32_t px, const int32_t py, const PortraitType type, fheroes::Image & dstsf ) const override;
    ...
    fheroes::Rect GetScoutRoi() const;
    ...
    const fheroes::Sprite & GetPortrait( const int type ) const
    {
    ...
    fheroes::Point MovementDirection() const;
    ...
    static const fheroes::Sprite & GetPortrait( const int heroId, const int portraitType );
...
public:
    ...
    Heroes * Get( const fheroes::Point & center ) const;
