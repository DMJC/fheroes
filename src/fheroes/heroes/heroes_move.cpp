...
fheroes::Point Heroes::getCurrentPixelOffset() const
{
    if ( _spriteIndex >= 45 ) {
        return {};
    }
    ...
    fheroes::Point realOffset{ _offset };
...
void Heroes::FadeOut( const int animSpeedMultiplier, const fheroes::Point & offset /* = {} */ ) const
{
...
void Heroes::FadeIn( const int animSpeedMultiplier, const fheroes::Point & offset /* = {} */ ) const
{
    assert( animSpeedMultiplier > 0 );
...
fheroes::Point Heroes::MovementDirection() const
{
