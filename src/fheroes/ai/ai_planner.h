...
namespace AI
{
    ...
    public:
        ...
        fheroes::GameMode KingdomTurn( Kingdom & kingdom );
    ...
    private:
        ...
        // Returns the state of the game. By default it should be end of turn.
        fheroes::GameMode HeroesTurn( VecHeroes & heroes, uint32_t & currentProgressValue, uint32_t endProgressValue, bool & moreTasksAvailable );
