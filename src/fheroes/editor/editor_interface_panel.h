...
namespace Interface
{
    ...
    public:
        ...
        fheroes::Rect getBrushArea() const;
    ...
    private:
        ...
        fheroes::Button _buttonMagnify;
        fheroes::Button _buttonUndo;
        fheroes::Button _buttonRedo;
        fheroes::Button _buttonSpecs;
        fheroes::Button _buttonFile;
        fheroes::Button _buttonSystem;

        fheroes::Rect _rectMagnify;
        fheroes::Rect _rectUndo;
        fheroes::Rect _rectRedo;
        fheroes::Rect _rectSpecs;
        fheroes::Rect _rectFile;
        fheroes::Rect _rectSystem;

        fheroes::Rect _rectInstruments;
        fheroes::Rect _rectInstrumentPanel;
        fheroes::Rect _rectEditorPanel;

        fheroes::Image _instrumentPanelBackground;

        std::array<fheroes::Button, Instrument::INSTRUMENTS_COUNT> _instrumentButtons;
        std::array<fheroes::Button, BrushSize::BRUSH_SIZE_COUNT> _brushSizeButtons;

        std::array<fheroes::Rect, Instrument::INSTRUMENTS_COUNT> _instrumentButtonsRect;
        std::array<fheroes::Rect, TerrainBrush::TERRAIN_COUNT> _terrainButtonsRect;
        std::array<fheroes::Rect, LandscapeObjectBrush::LANDSCAPE_COUNT> _landscapeObjectButtonsRect;
        std::array<fheroes::Rect, AdventureObjectBrush::ADVENTURE_COUNT> _adventureObjectButtonsRect;
        std::array<fheroes::Rect, KingdomObjectBrush::KINGDOM_OBJECTS_COUNT> _kingdomObjectButtonsRect;
        std::array<fheroes::Rect, BrushSize::BRUSH_SIZE_COUNT> _brushSizeButtonsRect;
        std::array<fheroes::Rect, 8> _eraseButtonsRect;
