...
namespace Interface
{
    ...
    public:
        ...
        fheroes::GameMode startEdit();

        static fheroes::GameMode eventLoadMap();
        static fheroes::GameMode eventNewMap();
        static fheroes::GameMode eventFileDialog();
        void eventViewWorld();
    ...
    private:
        ...
        fheroes::HistoryManager _historyManager;
