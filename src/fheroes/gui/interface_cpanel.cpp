...
void Interface::ControlPanel::ResetTheme()
{
    ...
    _buttons.reset( new Buttons( fheroes::AGG::GetICN( icn, 4 ), fheroes::AGG::GetICN( icn, 0 ), fheroes::AGG::GetICN( icn, 12 ), fheroes::AGG::GetICN( icn, 10 ),
                                 fheroes::AGG::GetICN( icn, 8 ) ) );
}

const fheroes::Rect & Interface::ControlPanel::GetArea() const
{
    return *this;
}
...
void Interface::ControlPanel::_redraw() const
{
    ...
    fheroes::AlphaBlit( _buttons->radar, display, rt_radar.x, rt_radar.y, alpha );
    fheroes::AlphaBlit( _buttons->icons, display, rt_icons.x, rt_icons.y, alpha );
    fheroes::AlphaBlit( _buttons->buttons, display, rt_buttons.x, rt_buttons.y, alpha );
    fheroes::AlphaBlit( _buttons->status, display, rt_status.x, rt_status.y, alpha );
    fheroes::AlphaBlit( _buttons->end, display, rt_end.x, rt_end.y, alpha );
}

fheroes::GameMode Interface::ControlPanel::QueueEventProcessing() const
{
