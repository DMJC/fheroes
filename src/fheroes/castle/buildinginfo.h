...
public:
    ...
    void Redraw() const;
    bool QueueEventProcessing( fheroes::ButtonBase & exitButton ) const;
...
{
public:
    DwellingsBar( Castle & cstl, const fheroes::Size & sz );

    void RedrawBackground( const fheroes::Rect & pos, fheroes::Image & dstsf ) override;
    void RedrawItem( DwellingItem & dwl, const fheroes::Rect & pos, fheroes::Image & dstsf ) override;
