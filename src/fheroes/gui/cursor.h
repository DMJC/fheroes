...
public:
    ...
    static fheroes::Rect updateCursorPosition( const int32_t x, const int32_t y );
    ...
    void setCustomImage( const fheroes::Image & image, const fheroes::Point & offset );
...
private:
    ...
    void SetOffset( int name, const fheroes::Point & defaultOffset );
...
private:
    ...
    const bool _visible{ fheroes::cursor().isVisible() };
};
