...
namespace
{
    const std::map<uint32_t, fheroes::SupportedLanguage> languageCRC32 = { { 0x406967B9, fheroes::SupportedLanguage::French }, // GoG version
                                                                            { 0x04745D1D, fheroes::SupportedLanguage::German }, // GoG version
                                                                            { 0x88774771, fheroes::SupportedLanguage::Polish }, // GoG version
                                                                            { 0xDB10FFD8, fheroes::SupportedLanguage::Russian }, // XXI Vek version
                                                                            { 0xD5CF8AF3, fheroes::SupportedLanguage::Russian }, // Buka version
                                                                            { 0x219B3124, fheroes::SupportedLanguage::Italian }, // ???
                                                                            { 0x1CEBD099, fheroes::SupportedLanguage::Czech } }; // CD Projekt

    // Strings in this map must in lower case and non translatable.
    const std::map<std::string, fheroes::SupportedLanguage, std::less<>> languageName
        = { { "pl", fheroes::SupportedLanguage::Polish },     { "polish", fheroes::SupportedLanguage::Polish },
            { "de", fheroes::SupportedLanguage::German },     { "german", fheroes::SupportedLanguage::German },
            { "fr", fheroes::SupportedLanguage::French },     { "french", fheroes::SupportedLanguage::French },
            { "ru", fheroes::SupportedLanguage::Russian },    { "russian", fheroes::SupportedLanguage::Russian },
            { "it", fheroes::SupportedLanguage::Italian },    { "italian", fheroes::SupportedLanguage::Italian },
            { "cs", fheroes::SupportedLanguage::Czech },      { "czech", fheroes::SupportedLanguage::Czech },
            { "nb", fheroes::SupportedLanguage::Norwegian },  { "norwegian", fheroes::SupportedLanguage::Norwegian },
            { "be", fheroes::SupportedLanguage::Belarusian }, { "belarusian", fheroes::SupportedLanguage::Belarusian },
            { "uk", fheroes::SupportedLanguage::Ukrainian },  { "ukrainian", fheroes::SupportedLanguage::Ukrainian },
            { "bg", fheroes::SupportedLanguage::Bulgarian },  { "bulgarian", fheroes::SupportedLanguage::Bulgarian },
            { "es", fheroes::SupportedLanguage::Spanish },    { "spanish", fheroes::SupportedLanguage::Spanish },
            { "pt", fheroes::SupportedLanguage::Portuguese }, { "portuguese", fheroes::SupportedLanguage::Portuguese },
            { "sv", fheroes::SupportedLanguage::Swedish },    { "swedish", fheroes::SupportedLanguage::Swedish },
            { "tr", fheroes::SupportedLanguage::Turkish },    { "turkish", fheroes::SupportedLanguage::Turkish },
            { "ro", fheroes::SupportedLanguage::Romanian },   { "romanian", fheroes::SupportedLanguage::Romanian },
            { "nl", fheroes::SupportedLanguage::Dutch },      { "dutch", fheroes::SupportedLanguage::Dutch },
            { "hu", fheroes::SupportedLanguage::Hungarian },  { "hungarian", fheroes::SupportedLanguage::Hungarian },
            { "da", fheroes::SupportedLanguage::Danish },     { "danish", fheroes::SupportedLanguage::Danish },
            { "sk", fheroes::SupportedLanguage::Slovak },     { "slovak", fheroes::SupportedLanguage::Slovak },
            { "vi", fheroes::SupportedLanguage::Vietnamese }, { "vietnamese", fheroes::SupportedLanguage::Vietnamese },
            { "el", fheroes::SupportedLanguage::Greek },      { "greek", fheroes::SupportedLanguage::Greek } };
}
...
namespace fheroes
{
    ...
    std::vector<SupportedLanguage> getSupportedLanguages()
    {
        ...
        fheroes::SupportedLanguage currentLanguage = fheroes::getLanguageFromAbbreviation( conf.getGameLanguage() );

        std::vector<fheroes::SupportedLanguage> validSupportedLanguages{ fheroes::SupportedLanguage::English };
        ...
        for ( const auto & [codePage, languages] : supportedLanguges ) {
            for ( const auto language : languages ) {
                ...
                if ( conf.setGameLanguage( fheroes::getLanguageAbbreviation( language ) ) ) {
                    validSupportedLanguages.emplace_back( language );
                }
            }
        }

        conf.setGameLanguage( fheroes::getLanguageAbbreviation( currentLanguage ) );
    ...
    {
        return fheroes::getLanguageFromAbbreviation( Settings::Get().getGameLanguage() );
    }
