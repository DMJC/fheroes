...
namespace ICN
{
    enum : int32_t
    {
        ...
        // HoMM1 main menu resources
        H1BTNS,    // BTNMAIN.ICN - HoMM1 main menu buttons (5 buttons × 2 states, 127×63 each)
        H1PANEL,   // REDBACK.BMP - HoMM1 red button panel backdrop (194×410)
        H1BTNCAMP, // BTNCMPGN.ICN - HoMM1 campaign hero buttons (5 buttons × 2 states, 127×63 each)

        // HoMM1 scenario selection resources
        H1NEWGAME_BMP, // NEWGAME.BMP - 322×459 scenario selection panel background
        H1NEWGAME_ICN, // NEWGAME.ICN - scenario selection UI elements (29 frames)
        H1BTNNEWGM,    // BTNNEWGM.ICN - scenario selection buttons (8 frames, 127×63 each)

        // HoMM1 high scores screen
        H1HISCORE_BMP, // HISCORE.BMP - 640×480 high scores background
        H1HISCORE_ICN, // HISCORE.ICN - high scores UI elements

        // HoMM1 adventure map border
        H1BORD_BMP, // BORD.BMP - 640×480 full-screen border/frame artwork

        // HoMM1 credits screen
        H1CREDITS_BMP, // CREDITS.BMP - 640×480 credits screen

        // HoMM1 map selection dialog
        H1REQUEST_BMP,  // REQUEST.BMP  - 320×331 map selection panel background
        H1REQEXTRA_BMP, // REQEXTRA.BMP - 320×141 map selection info panel (size/difficulty/description)
        H1REQUEST_ICN,  // REQUEST.ICN  - map selection UI elements (5 frames: 0=name bar, 1/2=OK, 3/4=Cancel)

        // Real ICNs need a special reference to ICN files. Put ICNs generated by the engine at the end of this enumeration.
        LAST_VALID_FILE_ICN,
        ...
        BUTTONS_EDITOR_FILE_DIALOG_GOOD,
        BUTTONS_EDITOR_FILE_DIALOG_EVIL,
        BUTTONS_ADVENTURE_OPTIONS_DIALOG_GOOD,
        BUTTONS_ADVENTURE_OPTIONS_DIALOG_EVIL,
        BUTTON_QUIT_GOOD,
        BUTTON_QUIT_EVIL,
        ...
        BUTTON_TOGGLE_ALL_ON_GOOD,
        BUTTON_TOGGLE_ALL_OFF_GOOD,
