...
namespace GameOver
{
    ...
    std::vector<fheroes::LocalizedString> GetActualDescription( const uint32_t conditions, const std::optional<fheroes::SupportedLanguage> mapLanguage );
    ...
    public:
        ...
        fheroes::GameMode checkGameOver();
