...
namespace
{
    ...
    const fheroes::Rect heroSpeedRoi{ optionOffset.x, optionOffset.y + offsetBetweenOptions.height, optionWindowSize, optionWindowSize };
    const fheroes::Rect enemySpeedRoi{ optionOffset.x + offsetBetweenOptions.width, optionOffset.y + offsetBetweenOptions.height, optionWindowSize, optionWindowSize };
    const fheroes::Rect hotKeyRoi{ optionOffset.x + offsetBetweenOptions.width * 2, optionOffset.y + offsetBetweenOptions.height, optionWindowSize, optionWindowSize };
    const fheroes::Rect interfaceRoi{ optionOffset.x, optionOffset.y + offsetBetweenOptions.height * 2, optionWindowSize, optionWindowSize };
    const fheroes::Rect textSupportModeRoi{ optionOffset.x + offsetBetweenOptions.width, optionOffset.y + offsetBetweenOptions.height * 2, optionWindowSize,
                                             optionWindowSize };
    const fheroes::Rect battlesRoi{ optionOffset.x + offsetBetweenOptions.width * 2, optionOffset.y + offsetBetweenOptions.height * 2, optionWindowSize,
                                     optionWindowSize };
    ...
    void drawHeroSpeed( const fheroes::Rect & optionRoi )
    {
        ...
        const fheroes::Sprite & heroSpeedIcon = fheroes::AGG::GetICN( ICN::SPANEL, heroSpeedIconId );
        std::string value;
        if ( heroSpeed == 10 ) {
            value = _( "Jump" );
        }
        ...
        fheroes::drawOption( optionRoi, heroSpeedIcon, _( "Hero Speed" ), std::move( value ), fheroes::UiOptionTextWidth::THREE_ELEMENTS_ROW );
    }

    void drawEnemySpeed( const fheroes::Rect & optionRoi )
    {
        const Settings & conf = Settings::Get();
        ...
        const fheroes::Sprite & aiSpeedIcon = fheroes::AGG::GetICN( ICN::SPANEL, aiSpeedIconId );
        ...
        fheroes::drawOption( optionRoi, aiSpeedIcon, _( "Enemy Speed" ), std::move( value ), fheroes::UiOptionTextWidth::THREE_ELEMENTS_ROW );
    }
    ...
    void drawInterfaceSettings( const fheroes::Rect & optionRoi )
    {
        const bool isEvilInterface = Settings::Get().isEvilInterfaceEnabled();
        const fheroes::Sprite & interfaceThemeIcon = fheroes::AGG::GetICN( ICN::SPANEL, isEvilInterface ? 17 : 16 );

        fheroes::drawOption( optionRoi, interfaceThemeIcon, _( "Interface" ), _( "Settings" ), fheroes::UiOptionTextWidth::THREE_ELEMENTS_ROW );
    }
    ...
    void drawBattles( const fheroes::Rect & optionRoi )
    {
        const Settings & conf = Settings::Get();
        if ( conf.BattleAutoResolve() ) {
            ...
            const fheroes::Sprite & autoBattleIcon = fheroes::AGG::GetICN( ICN::CSPANEL, spellcast ? 7 : 6 );
            fheroes::drawOption( optionRoi, autoBattleIcon, _( "Battles" ), std::move( value ), fheroes::UiOptionTextWidth::THREE_ELEMENTS_ROW );
        }
        else {
            const fheroes::Sprite & autoBattleIcon = fheroes::AGG::GetICN( ICN::SPANEL, 18 );
            fheroes::drawOption( optionRoi, autoBattleIcon, _( "Battles" ), _( "combatMode|Manual" ), fheroes::UiOptionTextWidth::THREE_ELEMENTS_ROW );
        }
    }
    ...
    DialogAction openSystemOptionsDialog( bool & saveConfiguration )
    {
        ...
        fheroes::ImageRestorer emptyDialogRestorer( display, windowRoi.x, windowRoi.y, windowRoi.width, windowRoi.height - 30 );
        ...
        const fheroes::Rect windowHeroSpeedRoi( heroSpeedRoi + windowRoi.getPosition() );
        const fheroes::Rect windowEnemySpeedRoi( enemySpeedRoi + windowRoi.getPosition() );
        const fheroes::Rect windowHotKeyRoi( hotKeyRoi + windowRoi.getPosition() );
        const fheroes::Rect windowInterfaceRoi( interfaceRoi + windowRoi.getPosition() );
        const fheroes::Rect windowTextSupportModeRoi( textSupportModeRoi + windowRoi.getPosition() );
        const fheroes::Rect windowBattlesRoi( battlesRoi + windowRoi.getPosition() );
        ...
        while ( le.HandleEvents() ) {
            ...
            if ( le.isMouseRightButtonPressedInArea( windowLanguageRoi ) ) {
                ...
                fheroes::showStandardTextMessage( _( "Hero Speed" ), _( "Change the speed at which your heroes move on the main screen." ), 0 );
            }
            else if ( le.isMouseRightButtonPressedInArea( windowEnemySpeedRoi ) ) {
                fheroes::showStandardTextMessage( _( "Enemy Speed" ),
                ...
                fheroes::showStandardTextMessage( _( "Interface Settings" ), _( "Change the interface settings of the game." ), 0 );
            }
                ...
                fheroes::showStandardTextMessage( _( "Battles" ), _( "Toggle instant battle mode." ), 0 );
            }
    ...
    void showSystemOptionsDialog()
    {
        ...
        while ( action != DialogAction::Close ) {
            ...
            case DialogAction::Graphics:
                saveConfiguration |= fheroes::openGraphicsSettingsDialog( rebildAdventureMap );
            ...
            case DialogAction::InterfaceSettings:
                saveConfiguration |= fheroes::openInterfaceSettingsDialog( rebildAdventureMap );
