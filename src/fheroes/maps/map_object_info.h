...
namespace Maps
{
    ...
    constexpr fheroes::Size maxActionObjectDimensions{ 4, 2 };
    ...
    {
        ObjectPartInfo( const MP2::ObjectIcnType icn, const uint32_t index, const fheroes::Point & offset, const MP2::MapObjectType type )
            : tileOffset( offset )
            , icnIndex( index )
            , objectType( type )
            , icnType( icn )
    ...
    {
        LayeredObjectPartInfo( const MP2::ObjectIcnType icn, const uint32_t index, const fheroes::Point & offset, const MP2::MapObjectType type,
    ...
    // Plus the fheroes Editor requires object type and index in order to save it,
