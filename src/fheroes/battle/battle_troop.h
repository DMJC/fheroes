...
namespace Battle
{
    ...
    public:
        ...
        fheroes::Point GetStartMissileOffset( const size_t direction ) const;
        ...
        fheroes::Point GetBackPoint() const;
        fheroes::Point GetCenterPoint() const;

        fheroes::Rect GetRectPosition() const
        {
        ...
        bool UpdateDirection( const fheroes::Rect & pos );
