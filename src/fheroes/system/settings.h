...
{
public:
    static constexpr const char * configFileName = "fheroes.cfg";
    ...
    const fheroes::Point & PosRadar() const
    {
        return pos_radr;
    }

    const fheroes::Point & PosButtons() const
    {
        return pos_bttn;
    }

    const fheroes::Point & PosIcons() const
    {
        return pos_icon;
    }

    const fheroes::Point & PosStatus() const
    {
        return pos_stat;
    }

    void SetPosRadar( const fheroes::Point & pt )
    {
        pos_radr = pt;
    }

    void SetPosButtons( const fheroes::Point & pt )
    {
        pos_bttn = pt;
    }

    void SetPosIcons( const fheroes::Point & pt )
    {
        pos_icon = pt;
    }

    void SetPosStatus( const fheroes::Point & pt )
    {
        pos_stat = pt;
    }
    ...
    const fheroes::ResolutionInfo & currentResolutionInfo() const
    {
        return _resolutionInfo;
    }

    fheroes::Point getSavedWindowPos() const
    {
        return _windowPos;
    }

    void setStartWindowPos( const fheroes::Point pos )
    {
        _windowPos = pos;
    }
...
private:
    ...
    fheroes::ResolutionInfo _resolutionInfo;
    fheroes::Point _windowPos;
    ...
    fheroes::Point pos_radr{ -1, -1 };
    fheroes::Point pos_bttn{ -1, -1 };
    fheroes::Point pos_icon{ -1, -1 };
    fheroes::Point pos_stat{ -1, -1 };
