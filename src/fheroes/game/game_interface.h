...
namespace Interface
{
    ...
    public:
        ...
        fheroes::GameMode EventDefaultAction();
        void EventOpenFocus() const;
        fheroes::GameMode EventSaveGame() const;
        void EventPuzzleMaps() const;
        static fheroes::GameMode EventScenarioInformation();
        void EventSystemDialog() const;
        void EventSwitchFocusedHero( const int32_t tileIndex );
        void EventNextHero();
        void EventNextTown();
        fheroes::GameMode EventHeroMovement();
        ...
        fheroes::GameMode EventNewGame() const;
        fheroes::GameMode EventLoadGame() const;
        fheroes::GameMode EventAdventureDialog();
        void EventViewWorld();
        fheroes::GameMode EventFileDialog() const;
        fheroes::GameMode EventEndTurn() const;
        fheroes::GameMode EventDigArtifact();
    ...
    private:
        ...
        fheroes::GameMode HumanTurn( const bool isLoadedFromSave );
