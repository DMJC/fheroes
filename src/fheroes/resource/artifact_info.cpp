...
namespace
{
    ...
    std::vector<fheroes::ArtifactData> artifactData;
    ...
    void populateArtifactData()
    {
        ...
        artifactData
            = {
                ...
                { gettext_noop( "Endless Cart of Ore" ),
                  ...
                  {},
                  {} },
                { gettext_noop( "Endless Pouch of Crystal" ), gettext_noop( "The %{name} provides %{count} unit of crystal per day." ), gettext_noop( "Taking shelter from a storm in a small cave, you notice a small patch of crystal in one corner. Curious, you break a piece off and notice that the original crystal grows the lost piece back. You decide to stuff the entire patch into a pouch and take it with you." ), {}, {} },
        ...
        artifactData[Artifact::UNKNOWN].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );

        artifactData[Artifact::ULTIMATE_BOOK].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 12 );

        artifactData[Artifact::ULTIMATE_SWORD].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 12 );

        artifactData[Artifact::ULTIMATE_CLOAK].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 12 );

        artifactData[Artifact::ULTIMATE_WAND].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 12 );

        artifactData[Artifact::ULTIMATE_SHIELD].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 6 );
        artifactData[Artifact::ULTIMATE_SHIELD].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 6 );

        artifactData[Artifact::ULTIMATE_STAFF].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 6 );
        artifactData[Artifact::ULTIMATE_STAFF].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 6 );

        artifactData[Artifact::ULTIMATE_CROWN].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 4 );
        artifactData[Artifact::ULTIMATE_CROWN].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 4 );
        artifactData[Artifact::ULTIMATE_CROWN].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 4 );
        artifactData[Artifact::ULTIMATE_CROWN].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 4 );

        artifactData[Artifact::GOLDEN_GOOSE].bonuses.emplace_back( fheroes::ArtifactBonusType::GOLD_INCOME, 10000 );

        artifactData[Artifact::ARCANE_NECKLACE].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 4 );

        artifactData[Artifact::CASTER_BRACELET].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 2 );

        artifactData[Artifact::MAGE_RING].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 2 );

        artifactData[Artifact::WITCHES_BROACH].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 3 );

        artifactData[Artifact::MEDAL_VALOR].bonuses.emplace_back( fheroes::ArtifactBonusType::MORALE, 1 );

        artifactData[Artifact::MEDAL_COURAGE].bonuses.emplace_back( fheroes::ArtifactBonusType::MORALE, 1 );

        artifactData[Artifact::MEDAL_HONOR].bonuses.emplace_back( fheroes::ArtifactBonusType::MORALE, 1 );

        artifactData[Artifact::MEDAL_DISTINCTION].bonuses.emplace_back( fheroes::ArtifactBonusType::MORALE, 1 );

        artifactData[Artifact::FIZBIN_MISFORTUNE].curses.emplace_back( fheroes::ArtifactCurseType::MORALE, 2 );

        artifactData[Artifact::THUNDER_MACE].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 1 );

        artifactData[Artifact::ARMORED_GAUNTLETS].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 1 );

        artifactData[Artifact::DEFENDER_HELM].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 1 );

        artifactData[Artifact::GIANT_FLAIL].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 1 );

        artifactData[Artifact::BALLISTA].bonuses.emplace_back( fheroes::ArtifactBonusType::EXTRA_CATAPULT_SHOTS, 1 );

        artifactData[Artifact::STEALTH_SHIELD].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 2 );

        artifactData[Artifact::DRAGON_SWORD].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 3 );

        artifactData[Artifact::POWER_AXE].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 2 );

        artifactData[Artifact::DIVINE_BREASTPLATE].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 3 );

        artifactData[Artifact::MINOR_SCROLL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 2 );

        artifactData[Artifact::MAJOR_SCROLL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 3 );

        artifactData[Artifact::SUPERIOR_SCROLL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 4 );

        artifactData[Artifact::FOREMOST_SCROLL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 5 );

        artifactData[Artifact::ENDLESS_SACK_GOLD].bonuses.emplace_back( fheroes::ArtifactBonusType::GOLD_INCOME, 1000 );

        artifactData[Artifact::ENDLESS_BAG_GOLD].bonuses.emplace_back( fheroes::ArtifactBonusType::GOLD_INCOME, 750 );

        artifactData[Artifact::ENDLESS_PURSE_GOLD].bonuses.emplace_back( fheroes::ArtifactBonusType::GOLD_INCOME, 500 );

        artifactData[Artifact::NOMAD_BOOTS_MOBILITY].bonuses.emplace_back( fheroes::ArtifactBonusType::LAND_MOBILITY, 600 );

        artifactData[Artifact::TRAVELER_BOOTS_MOBILITY].bonuses.emplace_back( fheroes::ArtifactBonusType::LAND_MOBILITY, 300 );

        artifactData[Artifact::RABBIT_FOOT].bonuses.emplace_back( fheroes::ArtifactBonusType::LUCK, 1 );

        artifactData[Artifact::GOLDEN_HORSESHOE].bonuses.emplace_back( fheroes::ArtifactBonusType::LUCK, 1 );

        artifactData[Artifact::GAMBLER_LUCKY_COIN].bonuses.emplace_back( fheroes::ArtifactBonusType::LUCK, 1 );

        artifactData[Artifact::FOUR_LEAF_CLOVER].bonuses.emplace_back( fheroes::ArtifactBonusType::LUCK, 1 );

        artifactData[Artifact::TRUE_COMPASS_MOBILITY].bonuses.emplace_back( fheroes::ArtifactBonusType::LAND_MOBILITY, 500 );
        artifactData[Artifact::TRUE_COMPASS_MOBILITY].bonuses.emplace_back( fheroes::ArtifactBonusType::SEA_MOBILITY, 500 );

        artifactData[Artifact::SAILORS_ASTROLABE_MOBILITY].bonuses.emplace_back( fheroes::ArtifactBonusType::SEA_MOBILITY, 1000 );

        artifactData[Artifact::EVIL_EYE].bonuses.emplace_back( fheroes::ArtifactBonusType::CURSE_SPELL_COST_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::ENCHANTED_HOURGLASS].bonuses.emplace_back( fheroes::ArtifactBonusType::EVERY_COMBAT_SPELL_DURATION, 2 );

        artifactData[Artifact::GOLD_WATCH].bonuses.emplace_back( fheroes::ArtifactBonusType::HYPNOTIZE_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 100 );

        artifactData[Artifact::SKULLCAP].bonuses.emplace_back( fheroes::ArtifactBonusType::MIND_INFLUENCE_SPELL_COST_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::ICE_CLOAK].bonuses.emplace_back( fheroes::ArtifactBonusType::COLD_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::FIRE_CLOAK].bonuses.emplace_back( fheroes::ArtifactBonusType::FIRE_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::LIGHTNING_HELM].bonuses.emplace_back( fheroes::ArtifactBonusType::LIGHTNING_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::EVERCOLD_ICICLE].bonuses.emplace_back( fheroes::ArtifactBonusType::COLD_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 50 );

        artifactData[Artifact::EVERHOT_LAVA_ROCK].bonuses.emplace_back( fheroes::ArtifactBonusType::FIRE_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 50 );

        artifactData[Artifact::LIGHTNING_ROD].bonuses.emplace_back( fheroes::ArtifactBonusType::LIGHTNING_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 50 );

        artifactData[Artifact::SNAKE_RING].bonuses.emplace_back( fheroes::ArtifactBonusType::BLESS_SPELL_COST_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::ANKH].bonuses.emplace_back( fheroes::ArtifactBonusType::RESURRECT_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 100 );

        artifactData[Artifact::BOOK_ELEMENTS].bonuses.emplace_back( fheroes::ArtifactBonusType::SUMMONING_SPELL_EXTRA_EFFECTIVENESS_PERCENT, 100 );

        artifactData[Artifact::ELEMENTAL_RING].bonuses.emplace_back( fheroes::ArtifactBonusType::SUMMONING_SPELL_COST_REDUCTION_PERCENT, 50 );

        artifactData[Artifact::HOLY_PENDANT].bonuses.emplace_back( fheroes::ArtifactBonusType::CURSE_SPELL_IMMUNITY );

        artifactData[Artifact::PENDANT_FREE_WILL].bonuses.emplace_back( fheroes::ArtifactBonusType::HYPNOTIZE_SPELL_IMMUNITY );

        artifactData[Artifact::PENDANT_LIFE].bonuses.emplace_back( fheroes::ArtifactBonusType::DEATH_SPELL_IMMUNITY );

        artifactData[Artifact::SERENITY_PENDANT].bonuses.emplace_back( fheroes::ArtifactBonusType::BERSERK_SPELL_IMMUNITY );

        artifactData[Artifact::SEEING_EYE_PENDANT].bonuses.emplace_back( fheroes::ArtifactBonusType::BLIND_SPELL_IMMUNITY );

        artifactData[Artifact::KINETIC_PENDANT].bonuses.emplace_back( fheroes::ArtifactBonusType::PARALYZE_SPELL_IMMUNITY );

        artifactData[Artifact::PENDANT_DEATH].bonuses.emplace_back( fheroes::ArtifactBonusType::HOLY_SPELL_IMMUNITY );

        artifactData[Artifact::WAND_NEGATION].bonuses.emplace_back( fheroes::ArtifactBonusType::DISPEL_SPELL_IMMUNITY );

        artifactData[Artifact::GOLDEN_BOW].bonuses.emplace_back( fheroes::ArtifactBonusType::NO_SHOOTING_PENALTY, GameStatic::getCastleWallRangedPenalty() );

        artifactData[Artifact::TELESCOPE].bonuses.emplace_back( fheroes::ArtifactBonusType::AREA_REVEAL_DISTANCE, 1 );

        artifactData[Artifact::STATESMAN_QUILL].bonuses.emplace_back( fheroes::ArtifactBonusType::SURRENDER_COST_REDUCTION_PERCENT, 10 );

        artifactData[Artifact::WIZARD_HAT].bonuses.emplace_back( fheroes::ArtifactBonusType::EVERY_COMBAT_SPELL_DURATION, 10 );

        artifactData[Artifact::POWER_RING].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POINTS_DAILY_GENERATION, 2 );

        artifactData[Artifact::AMMO_CART].bonuses.emplace_back( fheroes::ArtifactBonusType::ENDLESS_AMMUNITION );

        artifactData[Artifact::TAX_LIEN].curses.emplace_back( fheroes::ArtifactCurseType::GOLD_PENALTY, 250 );

        artifactData[Artifact::HIDEOUS_MASK].curses.emplace_back( fheroes::ArtifactCurseType::NO_JOINING_ARMIES );

        artifactData[Artifact::ENDLESS_POUCH_SULFUR].bonuses.emplace_back( fheroes::ArtifactBonusType::SULFUR_INCOME, 1 );

        artifactData[Artifact::ENDLESS_VIAL_MERCURY].bonuses.emplace_back( fheroes::ArtifactBonusType::MERCURY_INCOME, 1 );

        artifactData[Artifact::ENDLESS_POUCH_GEMS].bonuses.emplace_back( fheroes::ArtifactBonusType::GEMS_INCOME, 1 );

        artifactData[Artifact::ENDLESS_CORD_WOOD].bonuses.emplace_back( fheroes::ArtifactBonusType::WOOD_INCOME, 1 );

        artifactData[Artifact::ENDLESS_CART_ORE].bonuses.emplace_back( fheroes::ArtifactBonusType::ORE_INCOME, 1 );

        artifactData[Artifact::ENDLESS_POUCH_CRYSTAL].bonuses.emplace_back( fheroes::ArtifactBonusType::CRYSTAL_INCOME, 1 );

        artifactData[Artifact::SPIKED_HELM].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 1 );
        artifactData[Artifact::SPIKED_HELM].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 1 );

        artifactData[Artifact::SPIKED_SHIELD].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 2 );
        artifactData[Artifact::SPIKED_SHIELD].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 2 );

        artifactData[Artifact::WHITE_PEARL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 1 );
        artifactData[Artifact::WHITE_PEARL].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 1 );

        artifactData[Artifact::BLACK_PEARL].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 2 );
        artifactData[Artifact::BLACK_PEARL].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 2 );

        artifactData[Artifact::MAGIC_BOOK].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );
        artifactData[Artifact::EDITOR_ANY_ULTIMATE_ARTIFACT].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );
        artifactData[Artifact::UNUSED_84].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );
        artifactData[Artifact::UNUSED_85].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );
        artifactData[Artifact::UNUSED_86].bonuses.emplace_back( fheroes::ArtifactBonusType::NONE );

        artifactData[Artifact::SPELL_SCROLL].bonuses.emplace_back( fheroes::ArtifactBonusType::ADD_SPELL, Spell::NONE );

        artifactData[Artifact::ARM_MARTYR].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 3 );
        artifactData[Artifact::ARM_MARTYR].curses.emplace_back( fheroes::ArtifactCurseType::UNDEAD_MORALE_PENALTY );

        artifactData[Artifact::BREASTPLATE_ANDURAN].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 5 );

        artifactData[Artifact::BROACH_SHIELDING].bonuses.emplace_back( fheroes::ArtifactBonusType::ELEMENTAL_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );
        artifactData[Artifact::BROACH_SHIELDING].curses.emplace_back( fheroes::ArtifactCurseType::SPELL_POWER_SKILL, 2 );

        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 5 );
        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 5 );
        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 5 );
        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::MAXIMUM_MORALE );
        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::MAXIMUM_LUCK );
        artifactData[Artifact::BATTLE_GARB].bonuses.emplace_back( fheroes::ArtifactBonusType::ADD_SPELL, Spell::TOWNPORTAL );

        artifactData[Artifact::CRYSTAL_BALL].bonuses.emplace_back( fheroes::ArtifactBonusType::VIEW_MONSTER_INFORMATION );

        artifactData[Artifact::HEART_FIRE].bonuses.emplace_back( fheroes::ArtifactBonusType::FIRE_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );
        artifactData[Artifact::HEART_FIRE].curses.emplace_back( fheroes::ArtifactCurseType::COLD_SPELL_EXTRA_DAMAGE_PERCENT, 100 );

        artifactData[Artifact::HEART_ICE].bonuses.emplace_back( fheroes::ArtifactBonusType::COLD_SPELL_DAMAGE_REDUCTION_PERCENT, 50 );
        artifactData[Artifact::HEART_ICE].curses.emplace_back( fheroes::ArtifactCurseType::FIRE_SPELL_EXTRA_DAMAGE_PERCENT, 100 );

        artifactData[Artifact::HELMET_ANDURAN].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 5 );

        artifactData[Artifact::HOLY_HAMMER].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 5 );

        artifactData[Artifact::LEGENDARY_SCEPTER].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 2 );
        artifactData[Artifact::LEGENDARY_SCEPTER].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 2 );
        artifactData[Artifact::LEGENDARY_SCEPTER].bonuses.emplace_back( fheroes::ArtifactBonusType::KNOWLEDGE_SKILL, 2 );
        artifactData[Artifact::LEGENDARY_SCEPTER].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 2 );

        artifactData[Artifact::MASTHEAD].bonuses.emplace_back( fheroes::ArtifactBonusType::SEA_BATTLE_MORALE_BOOST, 1 );
        artifactData[Artifact::MASTHEAD].bonuses.emplace_back( fheroes::ArtifactBonusType::SEA_BATTLE_LUCK_BOOST, 1 );

        artifactData[Artifact::SPHERE_NEGATION].bonuses.emplace_back( fheroes::ArtifactBonusType::DISABLE_ALL_SPELL_COMBAT_CASTING );

        artifactData[Artifact::STAFF_WIZARDRY].bonuses.emplace_back( fheroes::ArtifactBonusType::SPELL_POWER_SKILL, 5 );

        artifactData[Artifact::SWORD_BREAKER].bonuses.emplace_back( fheroes::ArtifactBonusType::DEFENCE_SKILL, 4 );
        artifactData[Artifact::SWORD_BREAKER].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 1 );

        artifactData[Artifact::SWORD_ANDURAN].bonuses.emplace_back( fheroes::ArtifactBonusType::ATTACK_SKILL, 5 );

        artifactData[Artifact::SPADE_NECROMANCY].bonuses.emplace_back( fheroes::ArtifactBonusType::NECROMANCY_SKILL, 10 );

        for ( const fheroes::ArtifactData & artifact : artifactData ) {
            ...
            for ( const fheroes::ArtifactBonus & bonus : artifact.bonuses ) {
                if ( bonus.value < 0 ) {
                    assert( 0 );
                }
            }

            for ( const fheroes::ArtifactCurse & curse : artifact.curses ) {
                if ( curse.value < 0 ) {
                    assert( 0 );
                }
            }
