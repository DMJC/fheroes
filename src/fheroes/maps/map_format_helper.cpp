...
namespace
{
    ...
    int getGroundDirecton( const Maps::Map_Format::MapFormat & map, const int32_t centerTileIndex, const int groundId )
    {
        ...
        const fheroes::Point centerTile( centerTileIndex % map.width, centerTileIndex / map.width );
        ...
        for ( const int & direction : Direction::All() ) {
            ...
            fheroes::Point tilePosition = Maps::getDirectionPoint( centerTile, direction );
...
namespace Maps
{
    ...
    void setTerrainOnTiles( Map_Format::MapFormat & map, const int32_t startTileId, const int32_t endTileId, const int groundId )
    {
        ...
        const fheroes::Point startTileOffset( startTileId % map.width, startTileId / map.width );
        ...
        const fheroes::Point endTileOffset( endTileId % map.width, endTileId / map.width );
