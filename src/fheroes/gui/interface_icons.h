...
namespace Interface
{
    ...
    {
    public:
        IconsBar( const int32_t count, const fheroes::Image & markerImage )
            : _marker( markerImage )
            , _iconsCount( count )
        {
            assert( count >= 0 );
        ...
        void redrawBackground( fheroes::Image & output, const fheroes::Point & offset, const int32_t validItemCount ) const;
    ...
    {
    public:
        HeroesIcons( const int32_t count, const fheroes::Image & markerImage )
    ...
    private:
        ...
        void RedrawBackground( const fheroes::Point & pos ) override;

        fheroes::Point _topLeftCorner;
    };

    class CastleIcons final : public Interface::ListBox<CASTLE>, public IconsBar
    {
    public:
        CastleIcons( const int32_t count, const fheroes::Image & markerImage )
            : IconsBar( count, markerImage )
        {
            // Do nothing.
        }
